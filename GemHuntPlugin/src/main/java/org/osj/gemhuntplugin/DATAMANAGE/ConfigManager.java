package org.osj.gemhuntplugin.DATAMANAGE;
...
{
    private final String path = GemHuntPlugin.getServerInstance().getDataFolder().getAbsolutePath();
    ...
    public void reloadConfigs()
    {
        ...
        {
            GemHuntPlugin.getServerInstance().getLogger().info(key);
